...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/maksud/Public/Thesis/wfdb-10.5.22/build/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/maksud/Public/Thesis/wfdb-10.5.22/build/database).
...
# define DEFWFDB	". /home/maksud/Public/Thesis/wfdb-10.5.22/build/database"
#else
# define DEFWFDB ". /home/maksud/Public/Thesis/wfdb-10.5.22/build/database http://physionet.org/physiobank/database"
#endif
